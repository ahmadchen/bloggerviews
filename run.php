...
░░╚██╔╝░░██║███████╗░░╚██╔╝░╚██╔╝░███████╗██║░░██║
░░░╚═╝░░░╚═╝╚══════╝░░░╚═╝░░░╚═╝░░╚══════╝╚═╝░░╚═╝ /\n";
echo "$merah / CreatedBy : berbagiilmudanakalsehat(Subscribe Now) /\n";
echo "$magenta / YOUTUBE   : http://www.youtube.com/c/berbagiilmudanakalsehat /\n";
echo "$cyan ###################################################\n";
...
for($i = 1; $i < $max+1; $i++) {
	...
	echo $i.". View Added by Ahmadchen~ [".$class->jalankan()."]\n";
}
